--[[
     ...
     Based on Powerarrow Darker Awesome WM config 2.0 
...
tags = {
   ...
   layout = { layouts[1], layouts[2], layouts[3], layouts[1], layouts[4], layouts[1], layouts[1], layouts[1], layouts[1] }
}
    ...
    settings = function()
        if bat_now.status ~= "N/A" then
            if bat_now.ac_status == 1 then
                ...
                return
            elseif tonumber(bat_now.perc) and tonumber(bat_now.perc) <= 5 then
                baticon:set_image(beautiful.widget_battery_empty)
            elseif tonumber(bat_now.perc) and tonumber(bat_now.perc) <= 15 then
