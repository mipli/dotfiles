...
local bat = lain.widget.bat({
    settings = function()
        ...
        widget:set_markup(lain.util.markup.font(beautiful.font, lain.util.markup("#94928F", " Bat ") .. perc .. " "))
    end
})
...
local cpu = lain.widget.sysload({
    settings = function()
        widget:set_markup(lain.util.markup.font(beautiful.font, lain.util.markup("#94928F", " Cpu ") .. load_1 .. " "))
    end
})
-- }}}
...
local mem = lain.widget.mem({
    settings = function()
        widget:set_markup(lain.util.markup.font(beautiful.font, lain.util.markup("#94928F", " Mem ") .. mem_now.used .. " "))
    end
  })
-- }}}
...
clientkeys = gears.table.join(
    ...
    -- Keyboard switch
    awful.key({ modkey, "Shift" }, "r", function () kbdcfg.switch() end)
)
